...
export function Chapter1() {
  const navigation = <Navigation nextUrl="/chapter-2" prevUrl="/" />;
  ...
  return (
    <article>
      ...
      <p>
        ...
        to buy <em>Undine and Sintran</em> for myself. I've wanted it so long,"
      ...
      <p>
        ...
        only stay home and knit, like a poky old woman!"
      </p>
      ...
      <p>
        ...
        girls," said Beth, stroking the rough head with a hand that all the dish
      ...
      <p>
        ...
        least. A regular snow maiden, with blue eyes, and yellow hair curling on
        her shoulders, pale and slender, and always carrying herself like a
      ...
      <p>
        ...
        burn as she watched the fun with interest. "It's no use! Do the best you
        can when the time comes, and if the audience laughs, don't blame me.
        Come on, Meg."
      </p>
      ...
      <p>
        ...
        Operatic Tragedy_ is rather a nice thing, but I'd like to try _Macbeth_,
        if we only had a trapdoor for Banquo. I always wanted to do the killing
      ...
      <p>
        ...
        over-turning, and clattering everything she touched. Beth trotted to and
        fro between parlor kitchen, quiet and busy, while Amy gave directions to
      ...
      <p>
        ...
        fight their bosom enemies bravely, and conquer themselves so beautifully
        that when I come back to them I may be fonder and prouder than ever of
        my little women." Everybody sniffed when they came to that part. Jo
        wasn't ashamed of the great tear that dropped off the end of her nose,
        and Amy never minded the rumpling of her curls as she hid her face on
        her mother's shoulder and sobbed out, "I am a selfish girl! But I'll
        truly try to be better, so he mayn't be disappointed in me by-and-by."
      </p>
      ...
      <p>
        <em>Crinkle, crinkle, 'ittle 'tar,</em>
      </p>
      ...
      <p>
        ...
        singing like a lark, and the last sound at night was the same cheery
